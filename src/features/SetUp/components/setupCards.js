    ...
    return(
        <div className='container py-5 my-auto'>
            <div className='d-flex flex-row flex-wrap justify-content-center'>
                <div onClick={()=>{alert('Create Login')}} className='col-md-3 m-3 pt-2 align-items-center' style={{border:'1px solid white',borderRadius: '5px',minWidth:'230px',maxWidth:'300px', minHeight:'230px', background: 'rgb(255, 255, 255)', background: 'rgba(0, 0, 0, 0.1)'}}>
                ...
                <div onClick={()=>props.history.push(`/${RoutePath.Department}`)}className='col-md-3 m-3 pt-2 align-items-center' style={{border:'1px solid white',borderRadius: '10px',minWidth:'230px',maxWidth:'300px', minHeight:'230px', background: 'rgb(255, 255, 255)', background: 'rgba(0, 0, 0, 0.1)'}}>
                    <Cards icon={"fa fa-building-o fa-4x" } text={"Departments"} /> 
                </div>
                <div onClick={()=>{alert('Exit')}} className='col-md-3 m-3 pt-2 align-items-center' style={{border:'1px solid white',borderRadius: '10px',minWidth:'230px',maxWidth:'300px', minHeight:'230px', background: 'rgb(255, 255, 255)', background: 'rgba(0, 0, 0, 0.1)'}}>
